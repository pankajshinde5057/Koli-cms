...
urlpatterns = [
    ...
    path("manager/salary/edit/", EditSalaryView.as_view(),name='edit_employee_salary'),
    ...
    path("send_employee_notification/", ceo_views.send_employee_notification,name='send_employee_notification'),
    path("send_manager_notification/", ceo_views.send_manager_notification,name='send_manager_notification'),
    path("admin_notify_employee", ceo_views.admin_notify_employee,name='admin_notify_employee'),
    path("admin_notify_manager", ceo_views.admin_notify_manager,name='admin_notify_manager'),
    path("admin_view_profile", ceo_views.admin_view_profile,name='admin_view_profile'),
    path('admin-todays-attendance/', ceo_views.admin_todays_attendance, name='admin_todays_attendance'),
    path("check_email_availability", ceo_views.check_email_availability,name="check_email_availability"),
    path("employee/view/feedback/", ceo_views.employee_feedback_message,name="employee_feedback_message",),
    path("manager/view/feedback/", ceo_views.manager_feedback_message,name="manager_feedback_message",),
    path("employee/view/leave/", ceo_views.view_employee_leave,name="view_employee_leave",),
    path("manager/view/leave/", ceo_views.view_manager_leave, name="view_manager_leave",),
    path("attendance/view/", ceo_views.admin_view_attendance,name="admin_view_attendance",),
    ...
    path("manager/delete/<int:manager_id>",ceo_views.delete_manager, name='delete_manager'),
    ...
    path("division/delete/<int:division_id>",ceo_views.delete_division, name='delete_division'),
    path("department/delete/<int:department_id>",ceo_views.delete_department, name='delete_department'),
    path("employee/delete/<int:employee_id>",ceo_views.delete_employee, name='delete_employee'),
    path("employee/edit/<int:employee_id>",ceo_views.edit_employee, name='edit_employee'),
    path("division/edit/<int:division_id>",ceo_views.edit_division, name='edit_division'),
    path("department/edit/<int:department_id>",ceo_views.edit_department, name='edit_department'),
    ...
    path("admin/view/profile/", ceo_views.admin_view_profile,name='admin_view_profile'),
    ...
    path("manager/attendance/update-data/", manager_views.update_attendance,name='update_attendance'),
    path("manager/fcmtoken/", manager_views.manager_fcmtoken, name='manager_fcmtoken'),
    path("manager/view_asset/notification/", manager_views.manager_asset_view_notification,name="manager_asset_view_notification"),
    ...
    path('manager/salary/fetch/', manager_views.fetch_employee_salary,name='fetch_employee_salary'),
    path('manager/asset-approve/<int:notification_id>/', manager_views.approve_assest_request,name='approve_assest_request'),
    path('manager/asset-reject/<int:notification_id>/', manager_views.reject_assest_request,name='reject_assest_request'),
    path('manager/leave-approve/<int:leave_id>/', manager_views.approve_leave_request,name='approve_leave_request'),
    path('manager/leave-reject/<int:leave_id>/', manager_views.reject_leave_request,name='reject_leave_request'),
    ...
    path('employee/view/salary/', employee_views.employee_view_salary,name='employee_view_salary'),
    path('employee/view/requests-status/', employee_views.employee_requests,name='employee_requests'),  
    path('employee/daily_schedule/', employee_views.daily_schedule,name='daily_schedule'),  
