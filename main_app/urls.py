...
urlpatterns = [
     ...
     path('manager/get_attendance_details/', manager_views.get_attendance_details, name='get_attendance_details'),
     path('manager/update_attendance_data/', manager_views.update_attendance, name='update_attendance'),
